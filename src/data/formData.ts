...
export const formDataSpanish = [
  {
    type: 'text',
    label: 'Rol',
    description: 'Ingresa el rol, por ejemplo, Maestro, Doctor, Desarrollador',
    optional: false,
  },
  {
    type: 'textarea',
  ...
  {
    type: 'text',
    label: 'Notas adicionales / formato',
    description:
